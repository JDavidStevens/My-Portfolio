    ...
    return (
      <div className="about-wrapper" id="about">
        ...
        <div className="about-paragraphs">
          <p>
            I am a former brokerage representative, transitioning into a career
            in full stack web development. While enjoying my time working with
          ...
          <p>
            ...
            capabilities which technology provides to assist in that endeavor.
          </p>
